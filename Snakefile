...
if config['mergepairs'] == 'vsearch':
    rule vsearch_merge:
        ...
        output:
            fasta = temporary("{project}/mergepairs/{data}.fasta")
        params:
            minmergelen=config['vsearch_minmergelen']
...
if config["classification"] == "sina":
    rule download_silva_arb:
        output: temporary("SILVA_132_SSURef_NR99_13_12_17_opt.arb")
        shell: """
RELEASE=132
URL="https://www.arb-silva.de/fileadmin/silva_databases/release_${{RELEASE}}/ARB_files"

FILE="SILVA_${{RELEASE}}_SSURef_NR99_13_12_17_opt.arb.gz"
...
"""
    rule create_index_sina:
        input:
            "SILVA_132_SSURef_NR99_13_12_17_opt.arb"
        output:
            temporary("SILVA_132_SSURef_NR99_13_12_17_opt.arb.index.arb"),
            temporary("SILVA_132_SSURef_NR99_13_12_17_opt.arb.index.arb.pt"),
            temporary("SILVA_132_SSURef_NR99_13_12_17_opt.arb.index.ARM"),
            temporary("SILVA_132_SSURef_NR99_13_12_17_opt.arb.index.ARF")

        conda: "envs/sina.yaml"
        shell: """
cp SILVA_132_SSURef_NR99_13_12_17_opt.arb SILVA_132_SSURef_NR99_13_12_17_opt.arb.index.arb
arb_pt_server -build_clean -DSILVA_132_SSURef_NR99_13_12_17_opt.arb.index.arb
arb_pt_server -build -DSILVA_132_SSURef_NR99_13_12_17_opt.arb.index.arb
"""
    ...
    rule sina:
        input:
            ...
            index="SILVA_132_SSURef_NR99_13_12_17_opt.arb.index.arb",
            pt="SILVA_132_SSURef_NR99_13_12_17_opt.arb.index.arb.pt",
