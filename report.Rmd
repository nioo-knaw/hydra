...
Finally, taxonomic information for each OTU was added to the BIOM file by  aligning the sequences to the SILVA database (release 128) [@quast_silva_2013] using SINA [@pruesse_sina:_2012].
