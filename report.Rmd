...
Finally, taxonomic information for each OTU was added to the BIOM file by  aligning the sequences to the SILVA database (release 128) [@quast_silva_2013] using SINA [@pruesse_sina:_2012] . All steps were implemented in a Snakemake workflow [@koster_snakemakescalable_2012] as can be seen in Figure @fig:description.
